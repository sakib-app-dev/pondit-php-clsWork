...
<div class="zindex-modal-backdrop side-navbar active-nav d-flex justify-content-between flex-wrap flex-column bg-info" id="sidebar">
        <ul class="nav flex-column text-white w-100">
            ...
            <a href="profile.html"><li href="" class="nav-link">
             ...
             <a href="user-list.php"><li  class="nav-link">
                <i class="bx bx-user-check"></i>
                <span class="mx-2">User List</span>
            </li></a>
            <a href="category-add.php"><li href="" class="nav-link">
                <i class="bx bx-conversation"></i>
                <span class="mx-2">Create Category</span>
            </li></a>
            <a href="category-list.php"><li href="" class="nav-link">
                <i class="bx bx-conversation"></i>
                <span class="mx-2">Category List</span>
            </li></a>
            <a href="product-add.php"><li href="" class="nav-link">
                <i class="bx bxs-dashboard"></i>
                <span class="mx-2">Add Product </span>
            </li></a>
            <a href="product-list.php"><li href="" class="nav-link">
                <i class="bx bxs-dashboard"></i>
